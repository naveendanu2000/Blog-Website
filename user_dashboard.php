    ...
    <div class="container-fluid my-3 row">
        <aside class="container col-2 my-3" style="border-right: 1px solid black;">
            <div class='row my-2 px-4'>
                <button class="btn active" type="button" onclick="change('generalInfoBtn','user_general_info.php?login=<?php echo $login;?>')" id="generalInfoBtn">
                    Dashboard
                </button>
            </div>
            <div class='row my-2 px-4'><button class="btn" id="updateCredentials" onclick="change('updateCredentials','user_update_credentials.php?login=<?php echo $login;?>')">Update Credentials</button></div>
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                        <div class="accordian-body">
                            <ul class="list-group list-group-flush">
                                <button class="btn" onclick="change('publishedBtn','user_articles_published.php?login=<?php echo $login;?>')" id="publishedBtn">
                                    <li class="list-group-item">Published</li>
                                </button>
                                <button class="btn" onclick="change('draftedBtn','user_articles_drafted.php?login=<?php echo $login;?>')" id="draftedBtn">
        ...
        <section class="container col-10 text-center mt-2 mb-5">
            <div class="ratio ratio-16x9">
                <iframe id='frame' src="user_general_info.php?login=<?php echo $login;?>" title="dashboard"></iframe>
            </div>
        </section>
    </div>
    <script>
