...
include 'login.php';
$query = "SELECT * FROM articles where status = 'published' ORDER BY articles.a_id DESC";
...
<body style='font-family: "IBM Plex Sans", sans-serif;'>
    <nav class="navbar navbar-expand-lg bg-success-subtle">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Chugli</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?php if ($_SERVER['PHP_SELF'] == '/PHP basic course/mini_project/index.php') {
                                                echo 'active';
    ...
    <div class="container-fluid my-3 row">
        <section class="container col-10">
            <h3 class="h3 mb-4 mt-2 text-center">Latest Articles</h3>
            <?php
            // if (isset($_GET['login'])) {
            // if ($login != 'fail' && $login !='') {
            //     $login = $login;
