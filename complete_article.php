...
include 'login.php';
$query = "select * from articles where a_id = " . $_GET['a_id'];
$result = mysqli_query($conn, $query);
$rows = mysqli_fetch_assoc($result);
$title = $rows['title'];
$image = $rows['image'];
$article = $rows['article'];
$realted_query = "select * from articles where category = '" . $rows['category'] . "' and status = 'published'";
                ...
                <div class="d-flex">
                    <div class="nav-item dropdown mx-4 pt-2">
                        ...
                        <ul class="dropdown-menu px-2">
                            ...
                            <li class="drop-down-item">
                                <a class="nav-link mx-2" href="<?php echo $_SERVER['PHP_SELF'].'?a_id='.$_GET['a_id'] ?>">Log Out</a>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="container-fluid my-3 row">
        <section class="container col-8">
            ...
            echo '<article class="container-fluid row my-5 px-5">
                    ...
                    <div class="container row my-4"><img src=' . $image . ' width = "100%"></img></div>
                    <div class="container row"><p>' . $article . '</p></div>
                    </article>';
            ?>
        </section>
