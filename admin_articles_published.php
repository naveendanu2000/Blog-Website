...
if (isset($_POST['draft_article']) && isset($_GET['a_id'])) {
    $draft_query = "update articles set status = 'drafted' where a_id = " . $_GET['a_id'];
    ...
    <section class="container-fluid col text-center my-5 ">
        <table class="table table-hover">
            ...
            <tbody>
                <?php
                $i = 1;
                while ($rows = mysqli_fetch_assoc($p_articles_results)) {
                    echo '<tr data-bs-toggle="modal" data-bs-target="#exampleModal' . $i . '">
                                ...
                                <td>
                                <button type="submit" name="draft_article" class="btn btn-outline-warning mt-4 ms-2"
                                style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .6rem; --bs-btn-font-size: 1.0rem;">Draft</button></td>
                                <td>
