...
include 'login.php';
$query = "select * from articles where category = '" . $_GET['category'] . "' and status = 'published'";
$result = mysqli_query($conn, $query);
$realted_query = "select * from articles where category <> '" . $_GET['category'] . "' and status = 'published'";
$related_results = mysqli_query($conn, $realted_query);
...
<body style='font-family: "IBM Plex Sans", sans-serif;'>
                ...
                <div class="d-flex">
                    <div class="nav-item dropdown mx-4 pt-2">
                        ...
                        <ul class="dropdown-menu px-2">
                            ...
                            <li class="drop-down-item">
                                <a class="nav-link mx-2" href="<?php echo $_SERVER['PHP_SELF'] . '?category=' . $_GET['category'] ?>">Log Out</a>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="container-fluid my-3 row">
        <section class="container col-10">
            <h3 class="h3 mb-4 mt-2 text-center"><?php echo ucfirst($_GET['category']); ?></h3>
            <?php
            while ($rows = mysqli_fetch_assoc($result)) {
                echo '<article class="container-fluid row my-5 px-5">
                    ...
                    style="--bs-btn-padding-y: .05rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .95rem;"><a href="complete_article.php?a_id=' . $rows['a_id'] . '">read more</a></button></p></div>
                    </article>';
            }
            ?>
        </section>
